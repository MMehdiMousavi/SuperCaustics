...
SC is designed to be plug-and-play user friendly. Run the application, use [Probe](https://github.com/MMehdiMousavi/Probe "Probe, Image Resource Gatherer") to gather images, process the data using the notebook, and train your model using the data.
